...
# For creating random colors, we commented this because we have fixed color for our labels
...
def load_network(config_file, data_file, weights, batch_size=1):
    ...
    """ Our custom colors can be used in both image and video inference """
    # NWM: Red
	# WM: Green
	# IWM: Yellow
	
    colors = {'NWM': (0, 0, 255), 'WM': (0, 255, 0), 'IWM': (0, 255, 255)}
