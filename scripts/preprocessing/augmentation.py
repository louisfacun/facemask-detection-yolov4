...
Usage: python.py albumentation.py \
  --input <dir of train images> \
  --option <1-4 augmentations used in this study>
"""
...
def setup_augmentations(option):
    ...
    Parameters:
        option : int
          Between 1-3 of augmentation option available used in this study.
...
def process_images(files, input_folder, option):
    ...
    Parameters:
        ...
        input_folder : string
          Folder location of input images to augment.
